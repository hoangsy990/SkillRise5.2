...
$backup = Join-Path $qaRoot 'Bin\Engine-Port S21.before-slash-parser-51C7EF02.exe'
$oldHash = '51C7EF02466C21B64C6B09D8BF54AE413D189A488455561E4AB01080444562EF'
$newHash = 'D97C82327D438E979837B2CF656CB3B5CAAB7ED3536051519169088B169061A3'
...
Write-Output "PASS: isolated slash-parser QA staged $newHash; rollback retained at $backup"
