...
$backup = Join-Path $qaRoot 'Bin\Engine-Port S21.before-local-socket-guard-D97C8232.exe'
$oldHash = 'D97C82327D438E979837B2CF656CB3B5CAAB7ED3536051519169088B169061A3'
$newHash = '239C430335E4AA0ED89239FF387963F10D3FFF9ACFE4D9FFA6DE15A23106DF88'
...
Write-Output "PASS: isolated local-socket-guard QA staged $newHash; rollback retained at $backup"
