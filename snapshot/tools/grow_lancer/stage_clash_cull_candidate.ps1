...
$backup = Join-Path $qaRoot 'Bin\Engine-Port S21.before-clash-cull-23F59832.exe'
$oldHash = '23F598327786F6788476AC557CB0DA976AA15DEAF0CBAAA2D1D1C37D785A3893'
$newHash = '965A799AF4675BE57AA082AE22ACC9071DF0E314724CE1F553317FC6A7A727FB'
...
if ((Get-FileHash -Algorithm SHA256 -LiteralPath $staged).Hash -ne $newHash) {
    ...
    throw 'Staged hash mismatch; old QA restored'
}
Write-Output "PASS isolated Clash cull diagnostic staged=$newHash"
