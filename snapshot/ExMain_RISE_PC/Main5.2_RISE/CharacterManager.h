#pragma once
#include "RISE/GrowLancerClassIdentity.h"
...
class CCharacterManager
{
	...
	int IsFemale(int iClass) { return (this->GetBaseClass(iClass) == CLASS_ELF || this->GetBaseClass(iClass) == CLASS_SUMMONER || this->GetBaseClass(iClass) == rise::growlancer::kGrowLancerSourceBaseClass); }
	...
	CHARACTER* FindCharacterByName(const char* szName);
};
