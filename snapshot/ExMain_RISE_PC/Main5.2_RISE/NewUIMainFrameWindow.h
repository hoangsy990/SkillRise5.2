...
namespace SEASON3B
{
	...
	public:
		...
		void RenderSkillIcon(int iIndex, float x, float y, float width, float height, int TypeMuHelper = 0, bool bShowHotKey = true);
	...
	public:
		enum IMAGE_LIST
		{
			...
			IMAGE_MENU_LIST_SKILL = BITMAP_START_RISE_BIT + 9,
