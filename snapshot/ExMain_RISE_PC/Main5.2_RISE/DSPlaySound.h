...
enum
{
    ...
    SOUND_SLAYER_SWORD_INERTIA_START,
    SOUND_SLAYER_SWORD_INERTIA_ATTACK,
    SOUND_SLAYER_BAT_FLOCK_START,
    SOUND_SLAYER_BAT_FLOCK_ATTACK,
    SOUND_SLAYER_PIERCE_START,
    SOUND_SLAYER_PIERCE_ATTACK_1,
    SOUND_SLAYER_PIERCE_ATTACK_2,
    SOUND_SLAYER_PIERCE_ATTACK_3,
    SOUND_SLAYER_DETECTION,
#endif
    MAX_BUFFER
};
