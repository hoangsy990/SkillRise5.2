...
void CMapManager::Load()
{
	...
	LoadBitmapFile("Object8\\drop01.jpg", BITMAP_BUBBLE);
	...
	case WD_67DOPPLEGANGER3:
		...
		for (int i = 0; i < 32; i++)
		{
			...
			LoadBitmapFile(FileName, BITMAP_WATER + i, GL_LINEAR, GL_REPEAT, false);
		...
		break;
	case WD_8TARKAN:
		LoadBitmapFile("Object9\\sand01.jpg", BITMAP_CHROME + 2, GL_LINEAR, GL_REPEAT);
		LoadBitmapFile("Object9\\sand02.jpg", BITMAP_CHROME + 3, GL_LINEAR, GL_REPEAT);
		LoadBitmapFile("Object9\\Impack03.jpg", BITMAP_IMPACT, GL_LINEAR, GL_CLAMP_TO_EDGE);
	...
	case WD_10HEAVEN:
		...
		LoadBitmapFile("Effect\\cloudLight.jpg", BITMAP_CLOUD + 1, GL_LINEAR, GL_CLAMP_TO_EDGE);
		break;
	...
	case WD_34CRYWOLF_1ST:
	{
		...
		LoadBitmapFile("Effect\\Map_Smoke1.jpg", BITMAP_CHROME + 2, GL_LINEAR, GL_REPEAT);
		LoadBitmapFile("Effect\\Map_Smoke2.tga", BITMAP_CHROME + 3, GL_LINEAR, GL_REPEAT);
		LoadBitmapFile("Effect\\mhoujin_R.jpg", BITMAP_MAGIC_CIRCLE, GL_LINEAR, GL_CLAMP_TO_EDGE);
	...
	case WD_30BATTLECASTLE:
		LoadBitmapFile("Effect\\Map_Smoke1.jpg", BITMAP_CHROME + 2, GL_LINEAR, GL_REPEAT);
		LoadBitmapFile("Effect\\Map_Smoke2.tga", BITMAP_CHROME + 3, GL_LINEAR, GL_REPEAT);
		LoadBitmapFile("World31\\Map1.jpg", BITMAP_INTERFACE_MAP + 1, GL_LINEAR, GL_CLAMP_TO_EDGE);
		LoadBitmapFile("World31\\Map2.jpg", BITMAP_INTERFACE_MAP + 2, GL_LINEAR, GL_CLAMP_TO_EDGE);
	...
	case WD_31HUNTING_GROUND:
		...
		LoadBitmapFile("Effect\\clouds.jpg", BITMAP_CLOUD, GL_LINEAR, GL_CLAMP_TO_EDGE);
		LoadBitmapFile("Monster\\bossmap1_R.jpg", BITMAP_HGBOSS_PATTERN, GL_LINEAR, GL_CLAMP_TO_EDGE);
		LoadBitmapFile("Monster\\bosswing.tga", BITMAP_HGBOSS_WING, GL_NEAREST, GL_REPEAT);
	...
	case WD_38KANTURU_2ND:
	{
		...
		LoadBitmapFile("Npc\\khs_kan2gate001.jpg", BITMAP_KANTURU_2ND_NPC1, GL_LINEAR, GL_CLAMP_TO_EDGE);
		LoadBitmapFile("Npc\\khs_kan2gate003.jpg", BITMAP_KANTURU_2ND_NPC2, GL_LINEAR, GL_CLAMP_TO_EDGE);
		LoadBitmapFile("Npc\\khs_kan2gate004.jpg", BITMAP_KANTURU_2ND_NPC3, GL_LINEAR, GL_CLAMP_TO_EDGE);
	...
	{
		LoadBitmapFile("Monster\\nightmare_R.jpg", BITMAP_NIGHTMARE_EFFECT1, GL_LINEAR, GL_CLAMP_TO_EDGE);
		LoadBitmapFile("Monster\\nightmaresward_R.jpg", BITMAP_NIGHTMARE_EFFECT2, GL_LINEAR, GL_CLAMP_TO_EDGE);
		LoadBitmapFile("Monster\\nightmare_cloth.tga", BITMAP_NIGHTMARE_ROBE);
		LoadBitmapFile("Object40\\maya01_R.jpg", BITMAP_MAYA_BODY, GL_LINEAR, GL_CLAMP_TO_EDGE);
		LoadBitmapFile("Object40\\Mtowereffe.JPG", BITMAP_KANTURU3RD_OBJECT, GL_LINEAR, GL_CLAMP_TO_EDGE);
		LoadBitmapFile("Effect\\bluering0001_R.jpg", BITMAP_ENERGY_RING, GL_LINEAR, GL_CLAMP_TO_EDGE);
		LoadBitmapFile("Effect\\bluewave0001_R.jpg", BITMAP_ENERGY_FIELD, GL_LINEAR, GL_CLAMP_TO_EDGE);
	...
	case WD_45CURSEDTEMPLE_LV6:
	{
		...
		LoadBitmapFile("Effect\\ghosteffect01.jpg", BITMAP_GHOST_CLOUD1, GL_LINEAR, GL_CLAMP_TO_EDGE);
		LoadBitmapFile("Effect\\ghosteffect02.jpg", BITMAP_GHOST_CLOUD2, GL_LINEAR, GL_CLAMP_TO_EDGE);
		LoadBitmapFile("Effect\\torchfire.jpg", BITMAP_TORCH_FIRE, GL_LINEAR, GL_CLAMP_TO_EDGE);
	...
	case WD_41CHANGEUP3RD_1ST:
		LoadBitmapFile("Effect\\clouds.jpg", BITMAP_CLOUD, GL_LINEAR, GL_CLAMP_TO_EDGE);
		LoadBitmapFile("Effect\\firered.jpg", BITMAP_FIRE_RED, GL_LINEAR, GL_CLAMP_TO_EDGE);
		LoadBitmapFile("Effect\\FireSnuff.jpg", BITMAP_FIRE_SNUFF, GL_LINEAR, GL_CLAMP_TO_EDGE);      //  �Ҿ�.
	...
	case WD_78NEW_CHARACTER_SCENE:
		...
		{
			LoadBitmapFile("Logo\\New_Login_Back01.jpg", BITMAP_LOG_IN + 9);
			LoadBitmapFile("Logo\\New_Login_Back02.jpg", BITMAP_LOG_IN + 10);
			LoadBitmapFile("World78\\bg_b_05.jpg", BITMAP_CHROME + 3, GL_LINEAR, GL_REPEAT);
			LoadBitmapFile("World78\\bg_b_08.jpg", BITMAP_CHROME + 4, GL_LINEAR, GL_REPEAT);
			LoadBitmapFile("Logo\\MU-logo.tga", BITMAP_LOG_IN + 16, GL_LINEAR);
			LoadBitmapFile("Logo\\MU-logo_g.jpg", BITMAP_LOG_IN + 17, GL_LINEAR);
		...
		{
			LoadBitmapFile("Logo\\sos3sky01.jpg", BITMAP_LOG_IN + 9);
			LoadBitmapFile("Logo\\sos3sky02.jpg", BITMAP_LOG_IN + 10);
		}
	...
	case WD_66DOPPLEGANGER2:
	{
		LoadBitmapFile("Effect\\clouds.jpg", BITMAP_CLOUD, GL_LINEAR, GL_CLAMP_TO_EDGE);
		LoadBitmapFile("Effect\\FireSnuff.jpg", BITMAP_FIRE_SNUFF, GL_LINEAR, GL_CLAMP_TO_EDGE);
		LoadBitmapFile("Effect\\WATERFALL2.jpg", BITMAP_CHROME3, GL_LINEAR, GL_CLAMP_TO_EDGE);
		LoadBitmapFile("Effect\\clud64.jpg", BITMAP_CLUD64, GL_LINEAR, GL_CLAMP_TO_EDGE);
	}
	break;
	case WD_63PK_FIELD:
	...
	case WD_56MAP_SWAMP_OF_QUIET:
		LoadBitmapFile("Effect\\Map_Smoke1.jpg", BITMAP_CHROME + 2, GL_LINEAR, GL_REPEAT);
		LoadBitmapFile("Effect\\Map_Smoke2.tga", BITMAP_CHROME + 3, GL_LINEAR, GL_REPEAT);
		LoadBitmapFile("Monster\\red_shadows.jpg", BITMAP_SHADOW_PAWN_RED, GL_LINEAR, GL_REPEAT);
		LoadBitmapFile("Monster\\blue_shadows.jpg", BITMAP_SHADOW_KINGHT_BLUE, GL_LINEAR, GL_REPEAT);
		LoadBitmapFile("Monster\\green_shadows.jpg", BITMAP_SHADOW_ROOK_GREEN, GL_LINEAR, GL_REPEAT);
	...
	case WD_65DOPPLEGANGER1:
		...
		LoadBitmapFile("Effect\\Map_Smoke1.jpg", BITMAP_CHROME + 2, GL_LINEAR, GL_REPEAT);
		LoadBitmapFile("Object9\\sand02.jpg", BITMAP_CHROME + 3, GL_LINEAR, GL_REPEAT);
		LoadBitmapFile("Effect\\Chrome08.jpg", BITMAP_CHROME8, GL_LINEAR, GL_CLAMP_TO_EDGE);
		break;
	case WD_57ICECITY:
	...
	case WD_93EX702_CHARACTER_SCENE:
	case WD_94EX702_LOGIN_SCENE:
		if (gMapManager.WorldActive == WD_94EX702_LOGIN_SCENE)
		{
			LoadBitmapFile("Logo\\RISE-logo.tga", BITMAP_LOG_IN + 16, GL_LINEAR);
		}
		LoadBitmapFile("Effect\\clouds.jpg", BITMAP_CLOUD, GL_LINEAR, GL_CLAMP_TO_EDGE);
		break;
#endif
	...
	if (this->InHellas())
	{
		LoadBitmapFile("Object25\\water1.tga", BITMAP_MAPTILE, GL_LINEAR, GL_REPEAT, false);
		LoadBitmapFile("Object25\\water2.jpg", BITMAP_MAPTILE + 1, GL_NEAREST, GL_CLAMP_TO_EDGE);
	...
	LoadBitmapFile("Object8\\light01.jpg", BITMAP_SHINES, GL_LINEAR, GL_REPEAT);
...
void CMapManager::LoadWorld(int Map)
{
	...
	if (CreateWaterTerrain(this->WorldActive) == false)
	{
		...
		LoadBitmapFile(FileName, BITMAP_MAPTILE, GL_NEAREST, GL_REPEAT, false);
		sprintf(FileName, "%s\\TileGrass02.jpg", WorldName);
		LoadBitmapFile(FileName, BITMAP_MAPTILE + 1, GL_NEAREST, GL_REPEAT, false);
		if (this->WorldActive == WD_51HOME_6TH_CHAR
#ifndef PJH_NEW_SERVER_SELECT_MAP
			...
			)
		{
			...
			LoadBitmapFile(FileName, BITMAP_MAPTILE + 2, GL_NEAREST, GL_REPEAT, false);
		}
		else
		{
		...
		if (this->WorldActive == WD_39KANTURU_3RD)
		{
			...
			LoadBitmapFile(FileName, BITMAP_MAPTILE + 3, GL_NEAREST, GL_REPEAT, false);
		}
		else
		{
		...
		if (gMapManager.IsCursedTemple())
		{
			...
			LoadBitmapFile(FileName, BITMAP_MAPTILE + 4, GL_NEAREST, GL_REPEAT, false);
		}
		else
		{
		...
		LoadBitmapFile(FileName, BITMAP_MAPTILE + 5, GL_NEAREST, GL_REPEAT, false);
		sprintf(FileName, "%s\\TileWood01.jpg", WorldName);
		LoadBitmapFile(FileName, BITMAP_MAPTILE + 6, GL_NEAREST, GL_REPEAT, false);
		sprintf(FileName, "%s\\TileRock01.jpg", WorldName);
		LoadBitmapFile(FileName, BITMAP_MAPTILE + 7, GL_NEAREST, GL_REPEAT, false);
		sprintf(FileName, "%s\\TileRock02.jpg", WorldName);
		LoadBitmapFile(FileName, BITMAP_MAPTILE + 8, GL_NEAREST, GL_REPEAT, false);
		sprintf(FileName, "%s\\TileRock03.jpg", WorldName);
		LoadBitmapFile(FileName, BITMAP_MAPTILE + 9, GL_NEAREST, GL_REPEAT, false);

		if (this->WorldActive == WD_73NEW_LOGIN_SCENE || this->WorldActive == WD_74NEW_CHARACTER_SCENE
#if RISE_ENABLE_EX702_SELECT_SCENE
			|| this->WorldActive == WD_93EX702_CHARACTER_SCENE || this->WorldActive == WD_94EX702_LOGIN_SCENE
#endif
			)
		{
			sprintf(FileName, "%s\\AlphaTile01.Tga", WorldName);
			LoadBitmapFile(FileName, BITMAP_MAPTILE + 10, GL_NEAREST, GL_REPEAT, false);
		}
		else
		{
		...
		if (IRISEField() || IsDoppelGanger2())
		{

			LoadBitmapFile("Object64\\song_lava1.jpg", BITMAP_MAPTILE + 11, GL_NEAREST, GL_REPEAT, false);
		}
		else
		{
			sprintf(FileName, "%s\\TileRock05.jpg", WorldName);
			LoadBitmapFile(FileName, BITMAP_MAPTILE + 11, GL_NEAREST, GL_REPEAT, false);
		}
#ifdef ASG_ADD_MAP_KARUTAN
		if (IsKarutanMap())
		{
			sprintf(FileName, "%s\\AlphaTile01.Tga", WorldName);
			LoadBitmapFile(FileName, BITMAP_MAPTILE + 12, GL_NEAREST, GL_REPEAT, false);
		}
		else
		{
#endif	// ASG_ADD_MAP_KARUTAN
		...
		LoadBitmapFile(FileName, BITMAP_MAPTILE + 13, GL_NEAREST, GL_REPEAT, false);
		...
		for (int i = 1; i <= 16; i++)
		{
			...
			LoadBitmapFile(FileName, BITMAP_MAPTILE + 13 + i, GL_NEAREST, GL_REPEAT, false);
		}
		if (IRISEField() || IsDoppelGanger2())
		{
			sprintf(FileName, "%s\\TileGrass01_R.jpg", WorldName);
			LoadBitmapFile(FileName, BITMAP_MAPGRASS, GL_LINEAR, GL_REPEAT, false);
		}
		else
		{
			sprintf(FileName, "%s\\TileGrass01.tga", WorldName);
			LoadBitmapFile(FileName, BITMAP_MAPGRASS, GL_NEAREST, GL_REPEAT, false);
		}

		sprintf(FileName, "%s\\TileGrass02.tga", WorldName);
		LoadBitmapFile(FileName, BITMAP_MAPGRASS + 1, GL_NEAREST, GL_REPEAT, false);
		sprintf(FileName, "%s\\TileGrass03.tga", WorldName);
		LoadBitmapFile(FileName, BITMAP_MAPGRASS + 2, GL_NEAREST, GL_REPEAT, false);

		sprintf(FileName, "%s\\leaf01.tga", WorldName);
		LoadBitmapFile(FileName, BITMAP_LEAF1, GL_NEAREST, GL_CLAMP_TO_EDGE, false);
		sprintf(FileName, "%s\\leaf01.jpg", WorldName);
		LoadBitmapFile(FileName, BITMAP_LEAF1, GL_NEAREST, GL_CLAMP_TO_EDGE, false);
		sprintf(FileName, "%s\\leaf02.jpg", WorldName);
		LoadBitmapFile(FileName, BITMAP_LEAF2, GL_NEAREST, GL_CLAMP_TO_EDGE, false);

		if (M34CryWolf1st::IsCyrWolf1st() == true)
		{
			sprintf(FileName, "%s\\rain011.tga", "World1");
			LoadBitmapFile(FileName, BITMAP_RAIN, GL_NEAREST, GL_CLAMP_TO_EDGE, false);
		}
		else
		{
		...
		LoadBitmapFile(FileName, BITMAP_RAIN_CIRCLE, GL_NEAREST, GL_CLAMP_TO_EDGE, false);
		sprintf(FileName, "%s\\rain03.tga", "World10");
		LoadBitmapFile(FileName, BITMAP_RAIN_CIRCLE + 1, GL_NEAREST, GL_CLAMP_TO_EDGE, false);
...
{
#ifdef RISE_GROW_LANCER_RUNTIME_QA
    rise::growlancer::RecordMapEffectTeardownQA("map-before-delete");
#endif
    rise::growlancer::ResetAllEffectAnimationSamples();
	...
	{
        // Map teardown clears native effect slots without EffectDestructor.
        // Retire only the private Spin Step controller's style-1 object blur
        // before its owner slot can be reused on the next map. Stock SS6
        // effect/blur teardown ordering is preserved.
        if (Effects[i].Live &&
            Effects[i].Type == rise::growlancer::kSpinControllerModel &&
            Effects[i].SubType == 0)
            RemoveObjectBlurs(&Effects[i], 0);
		Effects[i].Live = false;
	}
#ifdef RISE_GROW_LANCER_RUNTIME_QA
    rise::growlancer::RecordMapEffectTeardownQA("map-after-delete");
#endif
}

bool CMapManager::InChaosCastle(int iMap)
{
	if (this->WorldActive == -1) return false;
...
const char* CMapManager::GetMapName(int iMap)
{
	switch (iMap)
	{
		case WD_34CRYWOLF_1ST: return GlobalText[1851];
		case WD_33AIDA: return GlobalText[1850];
		case WD_37KANTURU_1ST: return GlobalText[2177];
		case WD_38KANTURU_2ND: return GlobalText[2178];
		case WD_39KANTURU_3RD: return GlobalText[2179];
		case WD_40AREA_FOR_GM: return GlobalText[2324];
		case WD_51HOME_6TH_CHAR: return GlobalText[1853];
		case WD_57ICECITY: return GlobalText[1855];
		case WD_58ICECITY_BOSS: return GlobalText[1856];
		case WD_31HUNTING_GROUND: return GlobalText[59];
		case WD_30BATTLECASTLE: return GlobalText[669];
		case WD_10HEAVEN: return GlobalText[55 + iMap - WD_10HEAVEN];
		case WD_41CHANGEUP3RD_1ST: return GlobalText[1678];
		case WD_42CHANGEUP3RD_2ND: return GlobalText[1679];
		case WD_56MAP_SWAMP_OF_QUIET: return GlobalText[1854];
		case WD_62SANTA_TOWN: return GlobalText[2611];
		case WD_64DUELARENA: return GlobalText[2703];
		case WD_63PK_FIELD: return GlobalText[2686];
		case WD_65DOPPLEGANGER1:
		case WD_66DOPPLEGANGER2:
		case WD_67DOPPLEGANGER3:
		case WD_68DOPPLEGANGER4: return GlobalText[3057];
		case WD_69EMPIREGUARDIAN1:
		case WD_70EMPIREGUARDIAN2:
		case WD_71EMPIREGUARDIAN3:
		case WD_72EMPIREGUARDIAN4: return GlobalText[2806];
		case WD_79UNITEDMARKETPLACE: return GlobalText[3017];
		case WD_80KARUTAN1:
		case WD_81KARUTAN2: return GlobalText[3285];
		case WD_82NEW_CTC: return GlobalText[1450];
		case WD_83NEW_NARS: return GlobalText[1451];
		case WD_84NEW_ACHERON: return GlobalText[1452];
		case WD_85NEW_DEBENTER: return GlobalText[1453];
		case WD_86NEW_WARS: return GlobalText[1457];
		case WD_87THANMA: return GlobalText[1914];
		case WD_88BOSSGUILD: return GlobalText[1903];
		case WD_9DEVILSQUARE: return GlobalText[39];
	}
