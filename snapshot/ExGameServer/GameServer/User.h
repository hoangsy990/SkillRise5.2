...
#define OBJECT_START_USER_AND_BOTS (MAX_OBJECT-MAX_OBJECT_USER_AND_BOTS)
...
struct OBJECTSTRUCT
{
	...
	__int64 PhysiDamageMin;
	__int64 PhysiDamageMax;
	__int64 MagicDamageMin;
	__int64 MagicDamageMax;
	__int64 CurseDamageMin;
	__int64 CurseDamageMax;
	__int64 PhysiDamageMaxLeft;
	__int64 PhysiDamageMinLeft;
	__int64 PhysiDamageMaxRight;
	__int64 PhysiDamageMinRight;
	int DKDamageMultiplierRate;
	int DLDamageMultiplierRate;
	int SUDamageMultiplierRate;
	int DWDamageMultiplierRate;
	bool IsInBloodCastle = false;
	...
	int ManaShieldTime;
	int DamageReflectTime;
	int MagicCircleTime;
	int FitnessTime;
	int GreaterLifeTime;
	int GreaterDefenseTime;
	int GreaterDamageTime;
	int GreaterCriticalDamageTime;
	int GreaterIgnoreDefenseRateTime;
	int CmdAutoHp;
	short DBNumber;
	DWORD MarryTimeMsj;
	...
	int TongNap;
	int NhanMocNap;
	BYTE ExWQuestCurrent;
	BYTE ExWQuestStart;
	WORD ExWQuestNum;
	WORD ExWQuestCount[5];
	bool IsMakeCommand;
	int MakeCount;
	int MakeLoggedCount;
	// Transient connection capability only; never serialized to character data.
	rise::growlancer::BuffServerSession GrowLancerBuffSession;
};
enum ClassNumber {
  CLASS_WIZARD = 0x0,
  CLASS_KNIGHT = 0x1,
