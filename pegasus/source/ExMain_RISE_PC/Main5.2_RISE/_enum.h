...
namespace SEASON3B
{
	enum INTERFACE_LIST
	{
		...
		INTERFACE_DEMOFORM,
		INTERFACE_EXT_SHOP,
		INTERFACE_BOSS_GUILD,
		INTERFACE_THAN_MA,
		INTERFACE_EVENDANHHIEU,
		INTERFACE_IDLEVEL,
		INTERFACE_MOCNAP,
		INTERFACE_CHANGECLASS,
		INTERFACE_CHANGEPASS,
		...
		INTERFACE_EVENINVASION,
		INTERFACE_VIEWITEM,		
		INTERFACE_WINQUEST,
		INTERFACE_PKSYSTEM,
		INTERFACE_CASTLEEVENT,
		INTERFACE_RENDER_COLOR,
		INTERFACE_UI_NEWSYSTEM,
		INTERFACE_DUNGLUYEN,
		INTERFACE_HARMONY,
		INTERFACE_CONGHUONG,
		INTERFACE_EXTOPTION_CHAR,
		INTERFACE_RANKING_TOP_PK,
		INTERFACE_MIX_TRADER,
		INTERFACE_GUILD_UPGRADE,

		INTERFACE_UIITEM_TRADER,
	};
}
...
enum 
{
	...
	MODEL_PEGASUS_SWORD_BLOW_BIG = (MODEL_MASK_HELM+MAX_ITEM_INDEX),
	MODEL_PEGASUS_SWORD_BLOW_SMALL,
	MODEL_PEGASUS_SWORD_BLOW_PLANE,
	MODEL_PEGASUS_SWORD_BLOW_RING,
	MODEL_PEGASUS_SWORD_BLOW_MULTISHOT1,
	MODEL_PEGASUS_SWORD_BLOW_MULTISHOT2,
	MODEL_PEGASUS_SWORD_BLOW_MULTISHOT3,
	MODEL_PEGASUS_SWORD_BLOW_TARGET1,
