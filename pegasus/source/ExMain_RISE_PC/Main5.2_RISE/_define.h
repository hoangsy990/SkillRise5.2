...
// Extended equipment uses wire slots 236..242. Keep the normal inventory
// boundary at 12 so existing inventory packet indexes remain unchanged.
#define EQUIPMENT_PENTAGRAM    12
#define EQUIPMENT_MUUN         13
#define EQUIPMENT_EAGLE        14
#define EQUIPMENT_ERING_R      15
#define EQUIPMENT_ERING_L      16
#define EQUIPMENT_WING_CORE    17
#define EQUIPMENT_FLAG_NAT     18
#define MAX_NEW_EQUIPMENT      19
...
#define GET_ITEM_MODEL(x, y)  (((x) * 512) + (y) + MODEL_ITEM)
