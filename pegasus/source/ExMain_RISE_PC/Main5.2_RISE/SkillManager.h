...
enum ActionSkillType
{
	...
	AT_SKILL_LONGPIER_ATTACK      = 61,
	AT_SKILL_DARK_HORSE           = 62,
	AT_SKILL_PARTY_TELEPORT       = 63,
	AT_SKILL_ADD_CRITICAL         = 64,
	AT_SKILL_THUNDER_STRIKE       = 65,
	AT_SKILL_LONG_SPEAR           = 66,
	AT_SKILL_STUN                 = 67,
	AT_SKILL_REMOVAL_STUN         = 68,
	AT_SKILL_MANA                 = 69,
	AT_SKILL_INVISIBLE            = 70,
	AT_SKILL_REMOVAL_INVISIBLE    = 71,
	AT_SKILL_REMOVAL_BUFF         = 72,
	...
	AT_SKILL_DARK_SCREAM          = 78,
	AT_SKILL_EXPLODE              = 79,
	AT_IMPROVE_DAMAGE             = 80,
	AT_IMPROVE_MAGIC              = 81,
	AT_IMPROVE_CURSE              = 82,
	AT_IMPROVE_BLOCKING           = 83,
	AT_IMPROVE_DEFENSE            = 84,
	AT_LUCK                       = 85,

	AT_LIFE_REGENERATION              = 86,
	AT_IMPROVE_LIFE                  = 87,
	AT_IMPROVE_MANA                  = 88,
	AT_DECREASE_DAMAGE               = 89,
	AT_REFLECTION_DAMAGE             = 90,
	AT_IMPROVE_BLOCKING_PERCENT      = 91,
	AT_IMPROVE_GAIN_GOLD             = 92,
	AT_EXCELLENT_DAMAGE              = 93,
	AT_IMPROVE_DAMAGE_LEVEL          = 94,
	AT_IMPROVE_DAMAGE_PERCENT        = 95,
	AT_IMPROVE_MAGIC_LEVEL           = 96,
	AT_IMPROVE_MAGIC_PERCENT         = 97,
	AT_IMPROVE_ATTACK_SPEED          = 98,
	AT_IMPROVE_GAIN_LIFE             = 99,
	AT_IMPROVE_GAIN_MANA             = 100,
	AT_IMPROVE_HP_MAX                = 101,
	AT_IMPROVE_MP_MAX                = 102,
	AT_ONE_PERCENT_DAMAGE            = 103,
	AT_IMPROVE_AG_MAX                = 104,
	AT_DAMAGE_ABSORB                 = 105,
	AT_DAMAGE_REFLECTION             = 106,
	AT_RECOVER_FULL_LIFE             = 107,
	AT_RECOVER_FULL_MANA             = 108,
	AT_IMPROVE_CHARISMA              = 109,
	AT_IMPROVE_EVADE                 = 110,

	AT_SKILL_MONSTER_SUMMON          = 200,
	AT_SKILL_MONSTER_MAGIC_DEF       = 201,
	AT_SKILL_MONSTER_PHY_DEF         = 202,
	...
	AT_SKILL_ATTACK_RATEUP           = 630,
	AT_SKILL_TOMAN_ATTACKUP          = 635,
	AT_SKILL_TOMAN_DEFENCEUP         = 640,
	AT_SKILL_DURABLE_MINUS1          = 645,
	AT_SKILL_DURABLE_MINUS2          = 650,
	AT_SKILL_WIND_SOUL               = 737,
	AT_SKILL_RESIST_UP_POISON        = 655,
	AT_SKILL_RESIST_UP_LIGHT         = 660,
	AT_SKILL_RESIST_UP_ICE           = 665,
	AT_SKILL_AUTO_RECOVER_LIFE       = 670,
	AT_SKILL_GET_MONEY_UP            = 675,
	AT_SKILL_DEF_UP                  = 680,
	AT_SKILL_MAX_HP_UP               = 685,
	AT_SKILL_MAX_AG_UP               = 690,
	AT_SKILL_MANA_RECOVER            = 695,
	AT_SKILL_HP_RECOVER              = 700,
	AT_SKILL_SD_RECOVER              = 705,
};
