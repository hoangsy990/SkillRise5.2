...
#include "Protocol.h"
#include "User.h"
#define MAX_SKILL_TYPES 2048
#define MAX_SKILL_LIST 60
#define MAX_SKILL_CATALOG_ENTRIES 629
...
public:
	...
	bool SkillDeathside(int aIndex,int bIndex,CSkill* lpSkill,bool combo);
	bool SkillSwordBlow(int aIndex,int bIndex,CSkill* lpSkill,bool combo);
	bool SkillDragonViolent(int aIndex,int bIndex,CSkill* lpSkill,bool combo);
	bool SkillHavocSpear(int aIndex,int bIndex,CSkill* lpSkill,bool combo);
	bool SkillSpearstorm(int aIndex,int bIndex,CSkill* lpSkill,bool combo);
	bool SkillSwordWrath(int aIndex,CSkill* lpSkill);
	bool SkillPegasusSelfBuff(int aIndex,CSkill* lpSkill);
	...
	bool SkillWindSoul(int aIndex,int bIndex,CSkill* lpSkill,bool combo);
	bool SkillShiningBird(int aIndex,int bIndex,CSkill* lpSkill,BYTE angle,bool combo);
	...
	void GCPegasusTargetsSend(LPOBJ lpObj,int skill,const WORD* targets,BYTE count);
